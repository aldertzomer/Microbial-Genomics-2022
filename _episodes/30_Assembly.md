...
The assemblies for every k-mer setting are found in the folders marked K21, K33 K55 and are called simplified_contigs.fasta or final_contigs.fasta. The end result before scaffolding is called contigs.fasta and the scaffolded contigs are available in the file called scaffolds.fasta.
